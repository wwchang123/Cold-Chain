...
#define  PACKET_LENGTH      		0 		//0-64, 0:¶¯Ì¬Êý¾Ý³¤¶È 1:¹Ì¶¨Êý¾Ý³¤¶È


/** SI4463 IOÒý½ÅÓ²¼þ½Ó¿Ú¶¨Òå */
#define SI4463_SDN_PORT				GPIOB									
#define SI4463_SDN_PIN				GPIO_Pin_4

#define SI4463_IRQ_PORT				GPIOC									
#define SI4463_IRQ_PIN				GPIO_Pin_0

#define SI4463_GPIO0_PORT			GPIOA								
#define SI4463_GPIO0_PIN			GPIO_Pin_2

#define SI4463_GPIO1_PORT			GPIOA								
#define SI4463_GPIO1_PIN			GPIO_Pin_3

#define SI4463_GPIO2_PORT			GPIOB								
#define SI4463_GPIO2_PIN			GPIO_Pin_2

#define SI4463_GPIO3_PORT			GPIOB								
#define SI4463_GPIO3_PIN			GPIO_Pin_3


//IO²Ù×÷º¯Êý¶¨Òå
#define SI_SET_SDN_HIGH( )			SI4463_SDN_PORT->ODR |= SI4463_SDN_PIN
#define SI_SET_SDN_LOW( )			SI4463_SDN_PORT->ODR &= (uint8_t)((uint8_t)( ~SI4463_SDN_PIN ))

#define SI_SET_CSN_HIGH( )			spi_set_nss_high( )
#define SI_SET_CSN_LOW( )			spi_set_nss_low( )

#define IRQ_READ()    GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_0)         //¶ÁÈ¡Òý½ÅµçÆ½

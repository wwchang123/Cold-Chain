...
{
	//SDN 推完输出
	GPIO_Init( SI4463_SDN_PORT, SI4463_SDN_PIN, GPIO_Mode_Out_PP_High_Fast );
	
	//IRQ GPIO0~GPIO3上拉输入
	GPIO_Init( SI4463_IRQ_PORT, SI4463_IRQ_PIN,GPIO_Mode_In_PU_No_IT );
//	GPIO_Init( SI4463_GPIO0_PORT, SI4463_GPIO0_PIN,GPIO_Mode_In_PU_No_IT );
//	GPIO_Init( SI4463_GPIO1_PORT, SI4463_GPIO1_PIN,GPIO_Mode_In_PU_No_IT );
//	GPIO_Init( SI4463_GPIO3_PORT, SI4463_GPIO3_PIN,GPIO_Mode_In_PU_No_IT );
	GPIO_ResetBits( SI4463_SDN_PORT, SI4463_SDN_PIN );	//SDN 置低使能设备
}

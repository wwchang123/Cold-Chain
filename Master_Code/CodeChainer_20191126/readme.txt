...
IWDG_Init(7,4000); 更改在main.c里面的初始化看门狗配置  变25.6S
...
2019.11.12
	...
	0x04:表示未收到传感器数据重启
	0x05:表示未收到心跳包重启
	0x06:表示网络配置更新IP和端口重启
	0x07:表示第一次开机手动IP地址配置完成重启\
	0x08:表示手动IP地址配置完成重启
	0x09:表示网络平台控制重启
	
2019.11.17 

	未接收到服务器回发的心跳包，把原先的240S 改成 900S  ，也就是4分钟改成 15分钟
	
2019.11.27号
	更改无线模块的传输波特率。把原来的3K改成1K，为了增加模块的传输波特率  版本为 0x26
